...
class Control:
    ...
    def STATUS(self):
        """ Return the control status as a dictionary """
        status_dict = {}
        status_dict["IN0"] = self._JXC.read(self._JXC.IN0)
        status_dict["IN1"] = self._JXC.read(self._JXC.IN1)
        status_dict["IN2"] = self._JXC.read(self._JXC.IN2)
        status_dict["IN3"] = self._JXC.read(self._JXC.IN3)
        status_dict["IN4"] = self._JXC.read(self._JXC.IN4)
        status_dict["SETUP"] = self._JXC.read(self._JXC.SETUP)
        status_dict["HOLD"] = self._JXC.read(self._JXC.HOLD)
        status_dict["DRIVE"] = self._JXC.read(self._JXC.DRIVE)
        status_dict["RESET"] = self._JXC.read(self._JXC.RESET)
        status_dict["SVON"] = self._JXC.read(self._JXC.SETON)
        status_dict["OUT0"] = self._JXC.read(self._JXC.OUT0)
        status_dict["OUT1"] = self._JXC.read(self._JXC.OUT1)
        status_dict["OUT2"] = self._JXC.read(self._JXC.OUT2)
        status_dict["OUT3"] = self._JXC.read(self._JXC.OUT3)
        status_dict["OUT4"] = self._JXC.read(self._JXC.OUT4)
        status_dict["BUSY"] = self._JXC.read(self._JXC.BUSY)
        status_dict["AREA"] = self._JXC.read(self._JXC.AREA)
        status_dict["SETON"] = self._JXC.read(self._JXC.SETON)
        status_dict["INP"] = self._JXC.read(self._JXC.INP)
        status_dict["SVRE"] = self._JXC.read(self._JXC.SVRE)
        status_dict["ESTOP"] = (not self._JXC.read(self._JXC.ESTOP))
        status_dict["ALARM"] = (not self._JXC.read(self._JXC.ALARM))
        status_dict["BUSY1"] = self._JXC.read(self._JXC.BUSY1)
        status_dict["BUSY2"] = self._JXC.read(self._JXC.BUSY2)
        status_dict["BUSY3"] = self._JXC.read(self._JXC.BUSY3)
        status_dict["AREA1"] = self._JXC.read(self._JXC.AREA1)
        status_dict["AREA2"] = self._JXC.read(self._JXC.AREA2)
        status_dict["AREA3"] = self._JXC.read(self._JXC.AREA3)
        status_dict["INP1"] = self._JXC.read(self._JXC.INP1)
        status_dict["INP2"] = self._JXC.read(self._JXC.INP2)
        status_dict["INP3"] = self._JXC.read(self._JXC.INP3)
        status_dict["BRAKE1"] = (not self._JXC.read(self._JXC.BRAKE1))
        status_dict["BRAKE2"] = (not self._JXC.read(self._JXC.BRAKE2))
        status_dict["BRAKE3"] = (not self._JXC.read(self._JXC.BRAKE3))
        status_dict["ALARM1"] = (not self._JXC.read(self._JXC.ALARM1))
        status_dict["ALARM2"] = (not self._JXC.read(self._JXC.ALARM2))
        status_dict["ALARM3"] = (not self._JXC.read(self._JXC.ALARM3))
        # Write the status outputs to logging
        for key, value in status_dict.items():
            self.log.out("%s = %d" % (key, int(value)))
        return status_dict
